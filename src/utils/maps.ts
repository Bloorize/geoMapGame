...
const regionBounds: Record<string, { latRange: [number, number], lngRange: [number, number] }> = {
    ...
    'California': { latRange: [32, 42], lngRange: [-124, -114] },
    'New York': { latRange: [40, 45], lngRange: [-79, -72] },
    'Texas': { latRange: [25, 36], lngRange: [-106, -93] },
    'Florida': { latRange: [24, 31], lngRange: [-87, -80] },
    'Illinois': { latRange: [37, 42], lngRange: [-91, -87] },
    'Washington': { latRange: [45, 49], lngRange: [-124, -117] },
};
